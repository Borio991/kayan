...
// nav buttons
const btnService = document.querySelector('.services-scroll')
...
const sectionService = document.getElementById('services')
const sectionProjects = document.querySelector('#section-property')
const sectionNews = document.querySelector('#section-news')
const sectionContact = document.querySelector('#section-footer')
